...
from torchvision.models import ResNet, shufflenet_v2_x1_0, squeezenet1_0, mobilenet_v2
import math
import warnings
...
def fcanet50(num_classes=1000, pretrained=True):
...
def fcanet101(num_classes=1_000, pretrained=True):
